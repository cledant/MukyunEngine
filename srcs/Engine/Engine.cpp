		...
		_ubo_perspec_mult_view(0), _ubo_view_pos(0), _ubo_screen_resolution(0)
{
	...
	sr_params_cpy.ubo_screen_resolution = this->_ubo_screen_resolution;
	sr_params_cpy.ubo_perspec_mult_view = this->_ubo_perspec_mult_view;
	sr_params_cpy.ubo_view_pos          = this->_ubo_view_pos;
...
Engine::~Engine(void)
{
	glDeleteBuffers(1, &(this->_ubo_perspec_mult_view));
	glDeleteBuffers(1, &(this->_ubo_view_pos));
	glDeleteBuffers(1, &(this->_ubo_screen_resolution));
}
								  ...
								  ARenderBin::eType type)
{
	...
	params.ubo_perspec_mult_view = this->_ubo_perspec_mult_view;
	params.ubo_view_pos          = this->_ubo_view_pos;
	params.ubo_screen_resolution = this->_ubo_screen_resolution;
