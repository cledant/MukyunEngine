...
static void init_ressources(RessourceManager &rm)
{
	...
	rm.add_shader("MultiDirLightShadow", "./shaders/MultiDirLightShadow/MultiDirLightShadow_vs.glsl",
				  "./shaders/MultiDirLightShadow/MultiDirLightShadow_fs.glsl");
	rm.add_shader("DirLightShadowDepth", "./shaders/ShadowDepth/DirectionalShadow/DirectionalShadow_vs.glsl",
				  "./shaders/ShadowDepth/DirectionalShadow/DirectionalShadow_fs.glsl");
